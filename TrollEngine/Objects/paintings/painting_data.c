...
const PaintingData painting_texture_map_top[] = {
    85, // num mappings
    // Format:
    // mesh vtx ID, texture X, texture Y
       0, 2016,   72,
...
// 0x07022518
const PaintingData *const painting_texture_maps[] = {
    painting_texture_map_bottom,
    painting_texture_map_top,
};

Lights1 painting_lighting = gdSPDefLights1(
    0x50, 0x50, 0x50,
...
const GeoLayout geo_painting_object[] = {
   GEO_CULLING_RADIUS(32767),
   GEO_OPEN_NODE(),
      GEO_ASM(0, geo_painting_update),
      GEO_ASM(0, obj_geo_painting_draw),
   GEO_END(),
};
